      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg mx-auto text-gray-600">
            ...
            <p>
              Today, I am proud to be at the forefront of Web3 digital legacy preservation, combining cutting-edge technology with a deep understanding of what makes human connections meaningful across generations.
            </p>
          </div>
        </div>
